Ext.onReady(function(){
    ...
    var accountTemplateCountStore = new Ext.data.JsonStore({
        root: 'records',
        totalProperty: 'totalCount',
        idProperty: 'id',
        autoLoad:true,
        fields: ['id', 'share_template_id', 'account_id', 'account_name', 'count'],
        sortInfo: {
            field: 'Id',
            direction: 'ASC'
        },
        remoteSort: true,
        url: 'service.php?action=getAccountTemplateCount&ShareTemplateId='+template_id
    })
    
    var accountTemplateCountGrid = new Ext.grid.GridPanel({
        id: 'account-template-count-grid',
        title: 'Non-Shared Account Template',
        store: accountTemplateCountStore,
        //autoHeight: true,
        width: 290,
        height: 460,
        selModel: new Ext.grid.RowSelectionModel({}),
        columns:[
            {header: "Account", width: 230, align: 'center', sortable: true, dataIndex: 'account_name'},
            {header: "Count", width: 50, align: 'center', sortable: true, dataIndex: 'count'}
        ],
        listeners: {
            'dblclick': function(){
                var selections = accountTemplateCountGrid.selModel.getSelections();
                var account_id = selections[0].data.account_id;
                var account_name = selections[0].data.account_name;
                var account_template_id = selections[0].data.id;
                var share_template_id = selections[0].data.share_template_id;

                var accountTemplateForm = new Ext.form.FormPanel({
                    labelAlign: 'top',
                    reader:new Ext.data.JsonReader({
                    }, ['Id', 'ShareTemplateId', 'AccountId', 'StoreCategory2ID', 'StoreCategory2Name', 'StoreCategoryID', 'StoreCategoryName', 'GalleryURL',
                    ...
                    items: [{
                            ...
                            items:[{
                                ...
                                handler: function(){
                                    ...
                                    var storeCategoriesTree = new Ext.tree.TreePanel({
                                        ...
                                        dataUrl: 'service.php?action=getStoreCategoriesTree&account_id='+account_id,
                                        ...
                                        listeners:{
                                            click: function(n, e){
                                                if(n.leaf){
                                                    ...
                                                    accountTemplateForm.getForm().findField("storeCategory").setValue(categoryPath);
                                        ...
                                        listeners:{
                                            click: function(n, e){
                                                if(n.leaf){
                                                    ...
                                                    accountTemplateForm.getForm().findField("SStoreCategory").setValue(categoryPath);
                        ...
                        items:[{
                            ...
                            items:[{
                                xtype:"button",
                                text:"Edit Account Standard Style",
                                handler: function(){
                                    window.open(path + "account-style.php?account_id="+account_id+"&account_name="+account_name,"_blank","toolbar=no, location=yes, directories=no, status=no, menubar=yes, scrollbars=yes, resizable=no, copyhistory=yes, width=1024, height=768");
                                }
                            }]
                        },{
                            columnWidth:0.5,
                            ...
                            items:[{
                                ...
                                handler: function(){
                                    window.open(path + "preview.php?h=x&account_id="+account_id+"&share_template_id="+share_template_id,"_blank","toolbar=no, location=yes, directories=no, status=no, menubar=yes, scrollbars=yes, resizable=no, copyhistory=yes, width=1024, height=768");
                                }
                            }]
                        }]
                    }]
                ...
                var accountTemplateWindow = new Ext.Window({
                    title: account_name,
                    closable:true,
                    width: 700,
                    height: 380,
                    plain:true,
                    labelAlign: 'top',
                    items: accountTemplateForm,
                    buttons: [{
                        text: 'Ok',
                        handler: function(){
                            Ext.Ajax.request({  
                                waitMsg: 'Please Wait',
                                url: 'service.php?action=updateAccountTemplate', 
                                params: {
                                    account_id: account_id,
                                    account_template_id: account_template_id,
                                    share_template_id: template_id,
                                    StoreCategoryID: accountTemplateForm.getForm().findField('StoreCategoryID').getValue(),
                                    StoreCategoryName: accountTemplateForm.getForm().findField('storeCategory').getValue(),
                                    StoreCategory2ID: accountTemplateForm.getForm().findField('StoreCategory2ID').getValue(),
                                    StoreCategory2Name: accountTemplateForm.getForm().findField('SStoreCategory').getValue(),
                                    GalleryURL: accountTemplateForm.getForm().findField('GalleryURL').getValue(),
                                    picture_1: accountTemplateForm.getForm().findField('picture_1').getValue(),
                                    picture_2: accountTemplateForm.getForm().findField('picture_2').getValue(),
                                    picture_3: accountTemplateForm.getForm().findField('picture_3').getValue(),
                                    picture_4: accountTemplateForm.getForm().findField('picture_4').getValue(),
                                    picture_5: accountTemplateForm.getForm().findField('picture_5').getValue(),
                                    picture_6: accountTemplateForm.getForm().findField('picture_6').getValue(),
                                    picture_7: accountTemplateForm.getForm().findField('picture_7').getValue(),
                                    picture_8: accountTemplateForm.getForm().findField('picture_8').getValue(),
                                    picture_9: accountTemplateForm.getForm().findField('picture_9').getValue(),
                                    picture_10: accountTemplateForm.getForm().findField('picture_10').getValue()
                                }, 
                                success: function(response){
                                    ...
                                    if(result[0].success){
                                         ...
                                         accountTemplateWindow.close();
                                         accountTemplateCountStore.reload();
                ...
                accountTemplateWindow.show();
                
                accountTemplateForm.getForm().load({
                    url:'service.php?action=getAccountTemplate', 
                    method:'GET', 
                    params: {
                        account_template_id: account_template_id,
                        account_id: account_id
                    ...
                    success: function(f, a){
                        ...
                        if(Ext.isEmpty(Ext.getCmp("AccountId").getValue())){
                            Ext.getCmp("AccountId").setValue(account_id);
                        }
                    },
    ...
    var itemForm = new Ext.form.FormPanel({
        ...
        buttonAlign:"center",
        reader:new Ext.data.JsonReader({
            }, ['Id','AutoPay','BuyItNowPrice','CategoryMappingAllowed','Country','Currency','Description','DispatchTimeMax','ListingDuration','ListingType','Location','PaymentMethods',
                ...
                'StoreCategory2ID','StoreCategory2Name','StoreCategoryID','StoreCategoryName','SubTitle','Title','UserID','BoldTitle','Border','Featured','Highlight','HomePageFeatured',
                    ...
                    items:[{
                        ...
                        listeners: {
                            select: function(c, r, i){
                                ...
                                if(sku_to_share == "Y" && global_config.DS){
                                    Ext.Ajax.request({
                                        url: inventory_service + '?action=getSkuDescription&site=' + Ext.getCmp("SiteID").getValue() + '&sku=' + template_id,
            ...
            items:[{
                                ...
                                Ext.Ajax.request({
                                    ...
                                    success: function(a, b){
                                        ...
                                        */
                                        ...
                                        var itemSpecificsWindow = new Ext.Window({
                                            ...
                                            buttons:[{
                                                ...
                                                handler:function(){
                                                    itemSpecificsForm.getForm().submit({
                                                        clientValidation: true,
                                                        url: 'service.php?action=saveCustomSpecifics&template_id='+template_id,
                                                        success: function(form, action) {
                                                            itemSpecificsWindow.close();
                                                            //console.log(action);
                                                            //Ext.Msg.alert("Success", action.result.msg);
                                        ...
                                        itemSpecificsForm.getForm().load({
                                            url: 'service.php?action=loadCustomSpecifics&template_id='+template_id,
                                            waitMsg:'Please wait...',
                                            success: function(form, action){
                                                //console.log(action);
                                                /*
                ...
                items:[{
                    ...
                    items:[{
                                ...
                                style:"margin-top: 15px;",
                                handler: function(){
                                    window.open(path + "shippingTemplate.php?name=heshuai-temp&share=Y&site="+Ext.getCmp("SiteID").getValue(),"_blank","toolbar=no, location=yes, directories=no, status=no, menubar=yes, scrollbars=yes, resizable=no, copyhistory=yes, width=800, height=500");
                                }
                                ...
                                name:"SKU",
                                readOnly: true
                            },accountTemplateCountGrid]
                  }]
                }]
            }],
            buttons: [{
                text: (sku_to_share=="Y")?"Add To Share Template":"Update Share Template",
                handler: function(){
                    document.getElementById("Description").value = tinyMCE.get("Description").getContent();
                    itemForm.getForm().submit({
                        clientValidation: true,
                        url: 'service.php?action=updateShareTemplate&template_id='+template_id+"&sku_to_share="+((sku_to_share=="Y")?"Y":"N"),
                        success: function(form, action) {
                            //console.log(action);
                            Ext.Msg.alert("Success", action.result.msg);
                        },
    ...
    itemForm.getForm().load({
            url:'service.php?action=getShareTemplate', 
            method:'GET', 
            ...
            success: function(f, a){
                ...
                if(sku_to_share == "Y"){
                    Ext.getCmp("SKU").setValue(template_id);    
                }
