                    ...
                    items:[{
                        ...
                        items:[{
                            ...
                            items:[{
                                ...
                                text:"Preview",
                                handler: function(){
                                    window.open("/eBayBO/eBayListing/preview.php?t=t&u="+Ext.getCmp("UseStandardFooter").getValue()+"&id="+template_id+"&d="+Ext.getCmp("Description").getValue(),"_blank","toolbar=no, location=yes, directories=no, status=no, menubar=yes, scrollbars=yes, resizable=no, copyhistory=yes, width=1024, height=768");
                                }
                            }]
                        }]
                    }]
